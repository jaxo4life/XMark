...
<p align="center">
  <a href="#"><img src="https://img.shields.io/badge/version-6.4.0-blue.svg" alt="Version"></a>
...
- 📋 **Right Column Timeline** — after hiding the right rail, a native X List timeline lives in the freed third column: TweetDeck-style tab bar for multi-List switching (click the active tab to force-return to the list), iframe-embedded native page with deep in-frame cleaning, loading veil and background-freeze self-healing; managed in popup "Advanced" → "Enhance"
